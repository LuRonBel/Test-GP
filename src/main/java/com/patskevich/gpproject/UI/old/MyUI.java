...
public class MyUI extends UI {
    ...
    private final AdminForm adminForm = new AdminForm(this);
    private final UserForm userForm = new UserForm(this);
    public final Authentication auth = SecurityContextHolder.getContext().getAuthentication();
    ...
    final Grid<MessageDto> messageGrid = new Grid<>(MessageDto.class);
